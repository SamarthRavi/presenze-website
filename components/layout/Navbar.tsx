...
const BrandLogo = memo(function BrandLogo() {
  return (
    <div className="flex items-center gap-2.5" style={{ willChange: 'auto' }}>
...
const NavLink = memo(function NavLink({ 
  ...
  return (
    <Link
      ...
      style={{ willChange: isActive ? 'auto' : 'color' }}
    >
      {isActive && (
        <motion.span
...
const AdminButton = memo(function AdminButton() {
  return (
    <motion.a
...
export const Navbar = memo(function Navbar() {
  ...
  const onHomePage = useMemo(() => isHomePage(pathname), [pathname]);
  ...
  // Memoize nav animation variants
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex justify-center px-4 pt-4" style={{ willChange: 'auto' }}>
      <motion.nav
        initial={false}
        animate={navVariants}
        transition={{
      ...
      >
        ...
        {/* Desktop Navigation */}
        <nav className="hidden lg:flex items-center gap-1" style={{ willChange: 'auto' }}>
          {NAV_LINKS.map((link) => {
        ...
        {/* Right Actions */}
        <div className="flex items-center gap-3" style={{ willChange: 'auto' }}>
          ...
          <>
            ...
            >
              <div className="flex h-full flex-col">
                ...
                <nav className="flex-1 overflow-y-auto p-6" style={{ willChange: 'scroll-position' }}>
